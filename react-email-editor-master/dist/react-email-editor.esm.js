...
var EmailEditor = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var options = _extends({}, props.options || {}, {
    appearance: (_props$appearance = props.appearance) !== null && _props$appearance !== void 0 ? _props$appearance : (_props$options = props.options) === null || _props$options === void 0 ? void 0 : _props$options.appearance,
    displayMode: (props === null || props === void 0 ? void 0 : props.displayMode) || ((_props$options2 = props.options) === null || _props$options2 === void 0 ? void 0 : _props$options2.displayMode) || 'email',
    locale: (_props$locale = props.locale) !== null && _props$locale !== void 0 ? _props$locale : (_props$options3 = props.options) === null || _props$options3 === void 0 ? void 0 : _props$options3.locale,
    projectId: (_props$projectId = props.projectId) !== null && _props$projectId !== void 0 ? _props$projectId : (_props$options4 = props.options) === null || _props$options4 === void 0 ? void 0 : _props$options4.projectId,
    tools: (_props$tools = props.tools) !== null && _props$tools !== void 0 ? _props$tools : (_props$options5 = props.options) === null || _props$options5 === void 0 ? void 0 : _props$options5.tools,
    id: editorId,
    source: {
      name: pkg.name,
      version: pkg.version
